...
--
TextWidthCalculator.fontConfigFileName = nil;
...
--
TextWidthCalculator.cachedFontConfig = nil;
...
-- @tparam Bool _cacheFontConfig If true the font config will be loaded once and is then saved in a variable, if false the font config will be loaded from the .cfg file each time it is used
--
...
function TextWidthCalculator:getCharacterWidth(_character)
  ...
  if (self.cachedFontConfig ~= nil) then
